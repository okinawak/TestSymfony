...
class EtudiantController extends AbstractController
{
    ...
    #[Route('/sexe/{sexe}', name: 'app_etudiant_filtre', methods: ['GET'])]
    public function indexSexe(EtudiantRepository $etudiantRepository, $sexe): Response
    {
        return $this->render('etudiant/index.html.twig', [
            'etudiants' => $etudiantRepository->findBy(['sexe'=> $sexe ]),
